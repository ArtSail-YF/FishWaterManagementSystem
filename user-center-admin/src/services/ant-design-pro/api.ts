...
export async function login(body: API.LoginParams, options?: { [key: string]: any }) {
  return request<API.BaseResponse<API.LoginData>>('user/login/account', {
    method: 'POST',
    headers: {
...
/** 注册接口 POST /api/userregister/account */
export async function register(body: API.RegisterParams, options?: { [key: string]: any }) {
  return request<API.BaseResponse<API.RegisterData>>('user/register/account', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
